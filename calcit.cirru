...
{} (:package |bisection-key)
  :configs $ {} (:init-fn |bisection-key.main/main!) (:port 6001) (:reload-fn |bisection-key.main/reload!) (:version |0.0.14)
    :modules $ []
  :entries $ {}
                          ...
                          |j $ %{} :Expr (:at 1636888690339) (:by |Q7nwO-CJS)
                            :data $ {}
                              ...
                              |j $ %{} :Expr (:at 1636888694881) (:by |Q7nwO-CJS)
                                :data $ {}
                                  |D $ %{} :Leaf (:at 1636888697644) (:by |Q7nwO-CJS) (:text |pr-str)
                      ...
                      |j $ %{} :Expr (:at 1514652771595) (:by |root)
                        :data $ {}
                          ...
                          |j $ %{} :Expr (:at 1514652775089) (:by |root)
                            :data $ {}
                              |T $ %{} :Leaf (:at 1514652775472) (:by |root) (:text |{})
                              |j $ %{} :Expr (:at 1514652775802) (:by |root)
                                :data $ {}
                                  |T $ %{} :Leaf (:at 1514652777244) (:by |root) (:text ||a)
                                  |j $ %{} :Leaf (:at 1514652781255) (:by |root) (:text |1)
                                  |r $ %{} :Leaf (:at 1514652783579) (:by |root) (:text ||b)
                                  |v $ %{} :Leaf (:at 1514652806289) (:by |root) (:text |1)
